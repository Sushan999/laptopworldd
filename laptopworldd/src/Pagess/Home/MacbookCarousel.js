...
const MacbookCarousel = () => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get('http://localhost:4000/api/products', {
          params: {
            category: '66b13c8369c4a6802b10548e' // Updated category ID
          }
        });
  ...
  return (
    <div className="container mx-auto px-2 sm:px-4 lg:px-8 relative">
      <h1 className="text-3xl font-bold text-center my-8">Top MacBooks</h1>
      {selectedProduct ? (
...
export default MacbookCarousel;
